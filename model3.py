...
if __name__ == "__main__":
    app.run(port=4006, host="0.0.0.0", debug=False)
...
def get_flask_response(x):
    ...
    response = requests.post("http://127.0.0.1:4006/query-rag", json={"query": query})
...
evaluate(
    ...
    experiment_prefix="meta-llama/Llama-4-Scout-17B-16E-Instruct"
)
