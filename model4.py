...
if __name__ == "__main__":
    app.run(port=4007, host="0.0.0.0", debug=False)
...
def get_flask_response(x):
    ...
    response = requests.post("http://127.0.0.1:4007/query-rag", json={"query": query})
...
evaluate(
    ...
    experiment_prefix="meta-llama/llama-4-maverick-17b-128e-instruct"
)
